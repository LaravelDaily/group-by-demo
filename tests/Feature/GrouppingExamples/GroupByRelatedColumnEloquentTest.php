...
class GroupByRelatedColumnEloquentTest extends TestCase
{
    use RefreshDatabase;

    /**
     * @covers \App\Http\Controllers\GroupByRelatedColumnControllerWithEloquent
     * @return void
     */
    public function test_group_by_related_column_eloquent(): void
    {
